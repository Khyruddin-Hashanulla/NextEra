...
import {
  ...
  SubscriptionStatus,
  InstructorAssignmentDashboardResponse,
...
export const instructorApi = {
  ...
  getApplicationStatus: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ applied: boolean; status?: string; application?: any }>>(
  ...
  getRevenue: (startDate?: string, endDate?: string, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<InstructorRevenue>>('/instructor/revenue', {
  ...
  getCourse: (id: string, signal?: AbortSignal) => axiosInstance.get<ApiResponse<Course>>(`/courses/${id}`, { signal }),
  ...
  moveLecture: (courseId: string, lectureId: string, targetSectionId: string, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<Lecture>>(
      `/courses/${courseId}/lectures/${lectureId}/move`,
      { targetSectionId },
      { signal }
    ),
  ...
  getStudents: (params?: { page?: number; limit?: number; search?: string }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ students: InstructorStudent[]; pagination: any }>>('/instructor/students', {
      params,
      signal,
    }),

  listCoupons: (params?: { page?: number; limit?: number }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ coupons: InstructorCoupon[]; pagination: any }>>('/instructor/coupons', {
      params,
      signal,
    }),
  ...
  getReviews: (params?: { page?: number; limit?: number }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ reviews: InstructorReview[]; pagination: any }>>('/instructor/reviews', {
      params,
      signal,
    }),
  ...
  listAnnouncements: (params?: { page?: number; limit?: number }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ announcements: Announcement[]; pagination: any }>>('/instructor/announcements', {
      params,
      signal,
    }),

  createAnnouncement: (
    data: { course: string; title: string; message: string; sendEmail?: boolean },
    signal?: AbortSignal
  ...
  listNotifications: (params?: { page?: number; limit?: number }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ notifications: NotificationItem[]; total: number; unreadCount: number }>>(
      '/instructor/notifications',
      { params, signal }
    ),

  markNotificationRead: (id: string, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<NotificationItem>>(`/instructor/notifications/${id}/read`, undefined, { signal }),

  markAllNotificationsRead: (signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<{ success: boolean }>>('/instructor/notifications/read-all', undefined, { signal }),
  ...
  listCertificates: (params?: { page?: number; limit?: number }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ certificates: InstructorCertificate[]; pagination: any }>>(
  ...
  getInstructorPlans: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<InstructorSubscriptionPlan[]>>('/instructor/my-subscription/plans', { signal }),

  getInstructorSubscriptionOverview: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<InstructorSubscriptionOverview>>('/instructor/my-subscription/overview', { signal }),

  getInstructorEntitlements: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<InstructorEntitlementView>>('/instructor/my-subscription/entitlements', { signal }),

  subscribeToInstructorPlan: (planId: string, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<InstructorSubscriptionInitResult>>(
      '/instructor/my-subscription/subscribe',
      { planId },
      { signal }
    ),

  renewInstructorPlan: (planId: string, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<InstructorSubscriptionInitResult>>(
      '/instructor/my-subscription/renew',
      { planId },
      { signal }
    ),
  ...
  verifyInstructorSubscription: (
    ...
    axiosInstance.post<ApiResponse<{ success: boolean }>>('/instructor/my-subscription/payments/verify', data, {
      signal,
    }),
  ...
  getAssignments: (
    ...
    axiosInstance.get<ApiResponse<InstructorAssignmentDashboardResponse>>('/instructor/assignments', {
      params,
      signal,
    }),
  ...
  getLectureSubmissions: (
    ...
    axiosInstance.get<ApiResponse<InstructorSubmissionsResponse>>(`/instructor/assignments/${lectureId}/submissions`, {
      params,
      signal,
    }),

  getSubmissionDetail: (submissionId: string, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<InstructorSubmissionDetail>>(`/instructor/assignments/submissions/${submissionId}`, {
      signal,
    }),

  updateSubmissionStatus: (
    submissionId: string,
    data: { status: 'under_review' | 'rejected'; privateNotes?: string },
    signal?: AbortSignal
  ) =>
    axiosInstance.patch<ApiResponse<InstructorSubmissionDetail>>(
      `/instructor/assignments/submissions/${submissionId}/status`,
      data,
      { signal }
    ),
  ...
  returnForResubmission: (
    submissionId: string,
    data: { feedback?: string; privateNotes?: string; resubmissionDeadline?: string },
    signal?: AbortSignal
  ) =>
    axiosInstance.patch<ApiResponse<InstructorSubmissionDetail>>(
      `/instructor/assignments/submissions/${submissionId}/return`,
      data,
      { signal }
    ),
};
