...
import {
  ...
  InstructorSubscriptionStats,
  AffiliateItem,
  AffiliateStats,
  FeaturedPromotionItem,
  FeaturedPromotionStats,
} from '@/types/revenue';
import { LiveClassRecording } from '@/types/liveClass';

export const adminApi = {
  getDashboard: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<DashboardStats>>('/admin/dashboard', { signal }),

  getRevenueAnalytics: (startDate?: string, endDate?: string, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<RevenueAnalytics>>('/admin/analytics/revenue', {
      params: { startDate, endDate },
      signal,
    }),

  getUserAnalytics: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<UserAnalytics>>('/admin/analytics/users', { signal }),

  getCourseAnalytics: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<CourseAnalytics>>('/admin/analytics/courses', { signal }),
  ...
  getUserDetail: (id: string, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<any>>(`/admin/users/${id}`, { signal }),
  ...
  deleteUser: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/users/${id}`, { signal }),

  getPendingInstructors: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<any[]>>('/admin/instructors/pending', { signal }),
  ...
  approveInstructor: (id: string, adminNote?: string, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<InstructorApplication>>(
  ...
  rejectInstructor: (id: string, rejectionReason: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<InstructorApplication>>(`/admin/instructors/${id}`, {
  ...
  createCategory: (data: Partial<Category>, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<Category>>('/admin/categories', data, { signal }),
  ...
  deleteCategory: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/categories/${id}`, { signal }),
  ...
  createBlog: (data: Partial<Blog>, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<Blog>>('/admin/blog', data, { signal }),

  updateBlog: (id: string, data: Partial<Blog>, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<Blog>>(`/admin/blog/${id}`, data, { signal }),

  deleteBlog: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/blog/${id}`, { signal }),
  ...
  deleteCoupon: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/coupons/${id}`, { signal }),

  listNotifications: (params?: { page?: number; limit?: number }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ notifications: NotificationItem[]; pagination: any }>>('/admin/notifications', {
      params,
      signal,
    }),
  ...
  deleteNotification: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/notifications/${id}`, { signal }),

  getSettings: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<PlatformSettings>>('/admin/settings', { signal }),
  ...
  getWalletTransactions: (params?: { page?: number; limit?: number }, signal?: AbortSignal) =>
    axiosInstance.get<
      ApiResponse<{ transactions: WalletTransaction[]; total: number; page: number; totalPages: number }>
    >('/admin/wallet/transactions', { params, signal }),
  getCommissionSettings: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<CommissionSettings>>('/admin/wallet/commission', { signal }),
  getAllPayouts: (params?: { page?: number; limit?: number; status?: string }, signal?: AbortSignal) =>
    axiosInstance.get<
      ApiResponse<{ payouts: PayoutItem[]; summary: any; total: number; page: number; totalPages: number }>
    >('/admin/payouts', { params, signal }),
  processPayout: (id: string, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<PayoutItem>>(`/admin/payouts/${id}/process`, undefined, { signal }),
  approvePayout: (id: string, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<PayoutItem>>(`/admin/payouts/${id}/approve`, undefined, { signal }),
  processAllPendingPayouts: (signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<{ success: number; failed: number; errors: string[] }>>(
      '/admin/payouts/process-all',
      undefined,
      { signal }
    ),
  ...
  getCourseDetail: (id: string, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<any>>(`/admin/courses/${id}`, { signal }),
  approveCourse: (id: string, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<any>>(`/admin/courses/${id}/approve`, undefined, { signal }),
  rejectCourse: (id: string, reason?: string, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<any>>(`/admin/courses/${id}/reject`, { reason }, { signal }),
  publishCourse: (id: string, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<any>>(`/admin/courses/${id}/publish`, undefined, { signal }),
  unpublishCourse: (id: string, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<any>>(`/admin/courses/${id}/unpublish`, undefined, { signal }),
  archiveCourse: (id: string, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<any>>(`/admin/courses/${id}/archive`, undefined, { signal }),
  restoreCourse: (id: string, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<any>>(`/admin/courses/${id}/restore`, undefined, { signal }),

  listSubscriptionPlans: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<SubscriptionPlan[]>>('/admin/subscriptions', { signal }),
  createSubscriptionPlan: (data: Partial<SubscriptionPlan>, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<SubscriptionPlan>>('/admin/subscriptions', data, { signal }),
  updateSubscriptionPlan: (id: string, data: Partial<SubscriptionPlan>, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<SubscriptionPlan>>(`/admin/subscriptions/${id}`, data, { signal }),
  deleteSubscriptionPlan: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/subscriptions/${id}`, { signal }),
  ...
  createBanner: (data: Partial<Banner>, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<Banner>>('/admin/banners', data, { signal }),
  updateBanner: (id: string, data: Partial<Banner>, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<Banner>>(`/admin/banners/${id}`, data, { signal }),
  deleteBanner: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/banners/${id}`, { signal }),
  ...
  issueRefund: (
    paymentId: string,
    data: { amount: number; reason: string; refundType?: string; adminNote?: string },
    signal?: AbortSignal
  ...
  getSupportTicket: (id: string, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<SupportTicket>>(`/admin/tickets/${id}`, { signal }),
  ...
  assignTicket: (id: string, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<SupportTicket>>(`/admin/tickets/${id}/assign`, undefined, { signal }),
  ...
  listCertificates: (
    ...
    axiosInstance.get<ApiResponse<{ certificates: CertificateItem[]; pagination: any }>>('/admin/certificates', {
      params,
      signal,
    }),
  ...
  createFaq: (data: Partial<FaqItem>, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<FaqItem>>('/admin/faq', data, { signal }),
  updateFaq: (id: string, data: Partial<FaqItem>, signal?: AbortSignal) =>
    axiosInstance.put<ApiResponse<FaqItem>>(`/admin/faq/${id}`, data, { signal }),
  deleteFaq: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/faq/${id}`, { signal }),

  listEmailTemplates: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<EmailTemplate[]>>('/admin/email-templates', { signal }),
  ...
  deleteEmailTemplate: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/email-templates/${id}`, { signal }),
  ...
  listAuditActions: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<string[]>>('/admin/audit-actions', { signal }),
  listAuditResourceTypes: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<string[]>>('/admin/audit-resource-types', { signal }),
  listSecurityLogs: (
    params?: { page?: number; limit?: number; event?: string; severity?: string },
    signal?: AbortSignal
  ) =>
    axiosInstance.get<ApiResponse<{ logs: SecurityLogItem[]; pagination: any }>>('/admin/security-logs', {
      params,
      signal,
    }),
  ...
  createBackup: (signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<Backup>>('/admin/backups', undefined, { signal }),
  deleteBackup: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/backups/${id}`, { signal }),

  listCmsPages: (signal?: AbortSignal) => axiosInstance.get<ApiResponse<CmsPage[]>>('/admin/cms-pages', { signal }),
  createCmsPage: (data: Partial<CmsPage>, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<CmsPage>>('/admin/cms-pages', data, { signal }),
  ...
  deleteCmsPage: (id: string, signal?: AbortSignal) =>
    axiosInstance.delete<ApiResponse<null>>(`/admin/cms-pages/${id}`, { signal }),

  listRolePermissions: (signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<RolePermission[]>>('/admin/role-permissions', { signal }),
  createRolePermission: (data: Partial<RolePermission>, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<RolePermission>>('/admin/role-permissions', data, { signal }),
  ...
  getPaymentDetail: (id: string, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<PaymentItem>>(`/admin/payments/${id}`, { signal }),
  ...
  listWithdrawRequests: (params?: { page?: number; limit?: number; status?: string }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ payouts: WithdrawRequest[]; pagination: any }>>('/admin/withdraw-requests', {
      params,
      signal,
    }),
  ...
  listAffiliates: (params?: { page?: number; limit?: number; search?: string }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ affiliates: AffiliateItem[]; pagination: any }>>('/revenue/affiliates', {
      params,
      signal,
    }),
  ...
  listFeaturedPromotions: (params?: { page?: number; limit?: number; status?: string }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ promotions: FeaturedPromotionItem[]; pagination: any }>>('/revenue/promotions', {
      params,
      signal,
    }),
  ...
  getFeatures: (signal?: AbortSignal) => axiosInstance.get<ApiResponse<FeatureToggle[]>>('/admin/features', { signal }),
  ...
  listAssignments: (
    params?: { page?: number; limit?: number; status?: string; search?: string; sort?: string; courseId?: string },
    signal?: AbortSignal
  ) =>
    axiosInstance.get<ApiResponse<{ submissions: AdminAssignmentSubmission[]; pagination: any }>>(
      '/admin/assignments',
      { params, signal }
    ),
  ...
  getGradingLogs: (params?: { page?: number; limit?: number; courseId?: string }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ logs: GradingLogEntry[]; pagination: any }>>('/admin/assignments/grading-log', {
      params,
      signal,
    }),
  ...
  listRecordings: (
    ...
    axiosInstance.get<ApiResponse<{ recordings: LiveClassRecording[]; pagination: any }>>('/admin/recordings', {
      params,
      signal,
    }),
  ...
  syncRecording: (liveClassId: string, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<{ liveClassId: string; recordings: LiveClassRecording[] }>>(
