...
export const liveClassApi = {
  listInstructorLiveClasses: (
    params?: { page?: number; limit?: number; courseId?: string; status?: string },
    signal?: AbortSignal
  ) =>
    axiosInstance.get<ApiResponse<{ classes: LiveClass[]; pagination: any }>>('/live-classes/instructor', {
      params,
      signal,
    }),

  listInstructorRecordings: (params?: { page?: number; limit?: number; courseId?: string }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ recordings: LiveClassRecording[]; pagination: any }>>(
      '/live-classes/instructor/recordings',
      { params, signal }
    ),
  ...
  syncRecordings: (liveClassId: string, signal?: AbortSignal) =>
    axiosInstance.post<ApiResponse<{ liveClassId: string; recordings: LiveClassRecording[] }>>(
      '/live-classes/instructor/recordings/sync',
      { liveClassId },
      { signal }
    ),
  ...
  listStudentLiveClasses: (
    params?: { page?: number; limit?: number; filter?: 'upcoming' | 'past' | 'all' },
    signal?: AbortSignal
  ) =>
    axiosInstance.get<ApiResponse<{ classes: LiveClass[]; pagination: any }>>('/live-classes/student', {
      params,
      signal,
    }),
  ...
  listStudentRecordings: (params?: { page?: number; limit?: number; courseId?: string }, signal?: AbortSignal) =>
    axiosInstance.get<ApiResponse<{ recordings: LiveClassRecording[]; pagination: any }>>(
      '/live-classes/student/recordings',
      { params, signal }
    ),
