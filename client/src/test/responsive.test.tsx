...
describe('Text responsiveness', () => {
  it('applies responsive text sizes', () => {
    const { container } = wrap(<h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl">Heading</h1>);
...
describe('Image responsiveness', () => {
  it('uses responsive image classes', () => {
    const { container } = wrap(<img className="w-full h-auto sm:w-1/2 lg:w-1/3 xl:w-1/4" src="/test.jpg" alt="Test" />);
