...
export function ContactPage() {
  ...
  const contactInfo = [
    ...
    { icon: MapPin, title: 'Visit Us', value: '123 Learning Ave, San Francisco, CA 94102', href: 'https://maps.google.com' },
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground">
                We're here to help! Whether you have a question about our courses, need technical support, 
                or want to partner with us, don't hesitate to reach out.
              </p>

              <div className="space-y-4">
                {contactInfo.map((item) => (
                  <a key={item.title} href={item.href} className="group flex items-start gap-4 p-4 rounded-xl bg-card border hover:border-primary/50 transition-colors">
              ...
              <div className="pt-6 border-t">
                ...
                <div className="flex gap-4">
                  {['Twitter', 'LinkedIn', 'GitHub', 'YouTube'].map((platform) => (
                    <a key={platform} href="#" className="p-2 rounded-lg bg-muted text-muted-foreground hover:bg-primary/10 hover:text-primary transition-colors" aria-label={platform}>
                  ...
                  >
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        />
                        {errors.email && <p className="mt-1.5 text-sm text-destructive" role="alert">{errors.email.message}</p>}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      />
                      {errors.message && <p className="mt-1.5 text-sm text-destructive" role="alert">{errors.message.message}</p>}
                    </div>
        ...
        <Container>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              <Link key={item.title} to={item.href} className="group p-6 rounded-2xl bg-card border hover:border-primary/50 hover:shadow-lg transition-all">
