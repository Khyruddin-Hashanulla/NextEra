...
import { ArrowLeft, Download, Loader2, FileText, Save, CheckCircle, XCircle } from 'lucide-react';
...
export function AssignmentDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-sm">Override Grade</CardTitle>
        </CardHeader>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={String(submission.maxMarks || 100)}
              />
            </div>
            <div className="space-y-2">
