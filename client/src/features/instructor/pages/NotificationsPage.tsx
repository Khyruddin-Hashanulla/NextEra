...
export function NotificationsPage() {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: () => instructorApi.listNotifications().then((r: any) => r.data.data),
  });

  const readMutation = useMutation({
    mutationFn: (id: string) => instructorApi.markNotificationRead(id),
    onSuccess: () => {
  ...
  const readAllMutation = useMutation({
    mutationFn: () => instructorApi.markAllNotificationsRead(),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['instructor', 'notifications'] });
