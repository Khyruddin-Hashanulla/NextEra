...
const CommunityForumsPage = lazy(() =>
  import('@/features/community/pages/CommunityForumsPage').then((m) => ({ default: m.CommunityForumsPage }))
);
const CommunityTopicPage = lazy(() =>
  import('@/features/community/pages/CommunityTopicPage').then((m) => ({ default: m.CommunityTopicPage }))
);
const PublicCoursesPage = lazy(() =>
  import('@/features/public/pages/CoursesPage').then((m) => ({ default: m.CoursesPage }))
);
const CourseDetailPage = lazy(() =>
  import('@/features/public/pages/CourseDetailPage').then((m) => ({ default: m.CourseDetailPage }))
);
const PublicInstructorsPage = lazy(() =>
  import('@/features/public/pages/InstructorsPage').then((m) => ({ default: m.InstructorsPage }))
);
const InstructorProfilePage = lazy(() =>
  import('@/features/public/pages/InstructorProfilePage').then((m) => ({ default: m.InstructorProfilePage }))
);
const PublicBlogListPage = lazy(() =>
  import('@/features/public/pages/BlogListPage').then((m) => ({ default: m.BlogListPage }))
);
...
const CertificateVerifyPage = lazy(() =>
  import('@/features/certificates/pages/CertificateVerifyPage').then((m) => ({ default: m.CertificateVerifyPage }))
);

// AI Assistant
const AiAssistantPage = lazy(() =>
  import('@/features/ai/pages/AiAssistantPage').then((m) => ({ default: m.AiAssistantPage }))
);
...
const AnalyticsPage = lazy(() =>
  import('@/features/admin/pages/AnalyticsPage').then((m) => ({ default: m.AnalyticsPage }))
);
const RevenueDashboardPage = lazy(() =>
  import('@/features/admin/pages/RevenueDashboardPage').then((m) => ({ default: m.RevenueDashboardPage }))
);
const InstructorSubscriptionPlansPage = lazy(() =>
  import('@/features/admin/pages/InstructorSubscriptionPlansPage').then((m) => ({
    default: m.InstructorSubscriptionPlansPage,
  }))
);
const AffiliatesPage = lazy(() =>
  import('@/features/admin/pages/AffiliatesPage').then((m) => ({ default: m.AffiliatesPage }))
);
const FeaturedPromotionsPage = lazy(() =>
  import('@/features/admin/pages/FeaturedPromotionsPage').then((m) => ({ default: m.FeaturedPromotionsPage }))
);
const UsersPage = lazy(() => import('@/features/admin/pages/UsersPage').then((m) => ({ default: m.UsersPage })));
const InstructorsPage = lazy(() =>
  import('@/features/admin/pages/InstructorsPage').then((m) => ({ default: m.InstructorsPage }))
);
...
const NotificationsPage = lazy(() =>
  import('@/features/admin/pages/NotificationsPage').then((m) => ({ default: m.NotificationsPage }))
);
...
const AdminPayoutsPage = lazy(() =>
  import('@/features/admin/pages/PayoutsPage').then((m) => ({ default: m.PayoutsPage }))
);
const CourseManagementPage = lazy(() =>
  import('@/features/admin/pages/CourseManagementPage').then((m) => ({ default: m.CourseManagementPage }))
);
const CourseReviewPage = lazy(() =>
  import('@/features/admin/pages/CourseReviewPage').then((m) => ({ default: m.CourseReviewPage }))
);
const SubscriptionPlansPage = lazy(() =>
  import('@/features/admin/pages/SubscriptionPlansPage').then((m) => ({ default: m.SubscriptionPlansPage }))
);
const ReviewsModerationPage = lazy(() =>
  import('@/features/admin/pages/ReviewsModerationPage').then((m) => ({ default: m.ReviewsModerationPage }))
);
const BannerManagementPage = lazy(() =>
  import('@/features/admin/pages/BannerManagementPage').then((m) => ({ default: m.BannerManagementPage }))
);
const RefundManagementPage = lazy(() =>
  import('@/features/admin/pages/RefundManagementPage').then((m) => ({ default: m.RefundManagementPage }))
);
const SupportTicketsPage = lazy(() =>
  import('@/features/admin/pages/SupportTicketsPage').then((m) => ({ default: m.SupportTicketsPage }))
);
const CertificatesManagementPage = lazy(() =>
  import('@/features/admin/pages/CertificatesManagementPage').then((m) => ({ default: m.CertificatesManagementPage }))
);
const AdminAssignmentsPage = lazy(() =>
  import('@/features/admin/pages/AssignmentsPage').then((m) => ({ default: m.AssignmentsPage }))
);
const AdminAssignmentDetailPage = lazy(() =>
  import('@/features/admin/pages/AssignmentDetailPage').then((m) => ({ default: m.AssignmentDetailPage }))
);
const AdminGradingLogsPage = lazy(() =>
  import('@/features/admin/pages/GradingLogsPage').then((m) => ({ default: m.GradingLogsPage }))
);
const RecordingManagementPage = lazy(() =>
  import('@/features/admin/pages/RecordingManagementPage').then((m) => ({ default: m.RecordingManagementPage }))
);
...
const SecurityLogsPage = lazy(() =>
  import('@/features/admin/pages/SecurityLogsPage').then((m) => ({ default: m.SecurityLogsPage }))
);
const BackupRestorePage = lazy(() =>
  import('@/features/admin/pages/BackupRestorePage').then((m) => ({ default: m.BackupRestorePage }))
);
const FeatureTogglesPage = lazy(() =>
  import('@/features/admin/pages/FeatureTogglesPage').then((m) => ({ default: m.FeatureTogglesPage }))
);
const CMSPagesPage = lazy(() =>
  import('@/features/admin/pages/CMSPagesPage').then((m) => ({ default: m.CMSPagesPage }))
);
const RolePermissionsPage = lazy(() =>
  import('@/features/admin/pages/RolePermissionsPage').then((m) => ({ default: m.RolePermissionsPage }))
);
const PaymentManagementPage = lazy(() =>
  import('@/features/admin/pages/PaymentManagementPage').then((m) => ({ default: m.PaymentManagementPage }))
);
const StudentManagementPage = lazy(() =>
  import('@/features/admin/pages/StudentManagementPage').then((m) => ({ default: m.StudentManagementPage }))
);
const WithdrawRequestsPage = lazy(() =>
  import('@/features/admin/pages/WithdrawRequestsPage').then((m) => ({ default: m.WithdrawRequestsPage }))
);

// Instructor pages
const InstructorDashboardPage = lazy(() =>
  import('@/features/instructor/pages/DashboardPage').then((m) => ({ default: m.DashboardPage }))
);
const CoursesListPage = lazy(() =>
  import('@/features/instructor/pages/CoursesListPage').then((m) => ({ default: m.CoursesListPage }))
);
const CreateCoursePage = lazy(() =>
  import('@/features/instructor/pages/CreateCoursePage').then((m) => ({ default: m.CreateCoursePage }))
);
const EditCoursePage = lazy(() =>
  import('@/features/instructor/pages/EditCoursePage').then((m) => ({ default: m.EditCoursePage }))
);
const RevenuePage = lazy(() =>
  import('@/features/instructor/pages/RevenuePage').then((m) => ({ default: m.RevenuePage }))
);
const ApplyPage = lazy(() => import('@/features/instructor/pages/ApplyPage').then((m) => ({ default: m.ApplyPage })));
const InstructorPayoutsPage = lazy(() =>
  import('@/features/instructor/pages/PayoutsPage').then((m) => ({ default: m.InstructorPayoutsPage }))
);
const InstructorAnalyticsPage = lazy(() =>
  import('@/features/instructor/pages/AnalyticsPage').then((m) => ({ default: m.AnalyticsPage }))
);
const InstructorStudentPage = lazy(() =>
  import('@/features/instructor/pages/StudentManagementPage').then((m) => ({ default: m.StudentManagementPage }))
);
const InstructorCouponsPage = lazy(() =>
  import('@/features/instructor/pages/CouponsPage').then((m) => ({ default: m.CouponsPage }))
);
const InstructorReviewsPage = lazy(() =>
  import('@/features/instructor/pages/ReviewsPage').then((m) => ({ default: m.ReviewsPage }))
);
const AnnouncementsPage = lazy(() =>
  import('@/features/instructor/pages/AnnouncementsPage').then((m) => ({ default: m.AnnouncementsPage }))
);
const InstructorNotificationsPage = lazy(() =>
  import('@/features/instructor/pages/NotificationsPage').then((m) => ({ default: m.NotificationsPage }))
);
const InstructorEditProfilePage = lazy(() =>
  import('@/features/instructor/pages/EditProfilePage').then((m) => ({ default: m.EditProfilePage }))
);
const InstructorCertificatesPage = lazy(() =>
  import('@/features/instructor/pages/CertificatesPage').then((m) => ({ default: m.CertificatesPage }))
);
const InstructorSubscriptionPage = lazy(() =>
  import('@/features/instructor/pages/InstructorSubscriptionPage').then((m) => ({
    default: m.InstructorSubscriptionPage,
  }))
);
const InstructorLiveClassesPage = lazy(() =>
  import('@/features/instructor/pages/LiveClassesPage').then((m) => ({ default: m.LiveClassesPage }))
);
const InstructorAssignmentsPage = lazy(() =>
  import('@/features/instructor/pages/AssignmentsPage').then((m) => ({ default: m.AssignmentsPage }))
);
const InstructorSubmissionsPage = lazy(() =>
  import('@/features/instructor/pages/SubmissionsPage').then((m) => ({ default: m.SubmissionsPage }))
);
const InstructorSubmissionDetailPage = lazy(() =>
  import('@/features/instructor/pages/SubmissionDetailPage').then((m) => ({ default: m.SubmissionDetailPage }))
);

// Student pages
const StudentDashboardPage = lazy(() =>
  import('@/features/student/pages/DashboardPage').then((m) => ({ default: m.DashboardPage }))
);
const MyCoursesPage = lazy(() =>
  import('@/features/student/pages/MyCoursesPage').then((m) => ({ default: m.MyCoursesPage }))
);
const CoursePlayerPage = lazy(() =>
  import('@/features/student/pages/CoursePlayerPage').then((m) => ({ default: m.CoursePlayerPage }))
);
const NotesPage = lazy(() => import('@/features/student/pages/NotesPage').then((m) => ({ default: m.NotesPage })));
const QuizzesPage = lazy(() =>
  import('@/features/student/pages/QuizzesPage').then((m) => ({ default: m.QuizzesPage }))
);
const AssignmentsPage = lazy(() =>
  import('@/features/student/pages/AssignmentsPage').then((m) => ({ default: m.AssignmentsPage }))
);
const StudentAssignmentDetailPage = lazy(() =>
  import('@/features/student/pages/AssignmentDetailPage').then((m) => ({ default: m.AssignmentDetailPage }))
);
const StudentCertificatesPage = lazy(() =>
  import('@/features/student/pages/CertificatesPage').then((m) => ({ default: m.CertificatesPage }))
);
const WishlistPage = lazy(() =>
  import('@/features/student/pages/WishlistPage').then((m) => ({ default: m.WishlistPage }))
);
const OrderHistoryPage = lazy(() =>
  import('@/features/student/pages/OrderHistoryPage').then((m) => ({ default: m.OrderHistoryPage }))
);
const StudentNotificationsPage = lazy(() =>
  import('@/features/student/pages/NotificationsPage').then((m) => ({ default: m.NotificationsPage }))
);
const StudentAnnouncementsPage = lazy(() =>
  import('@/features/student/pages/AnnouncementsPage').then((m) => ({ default: m.AnnouncementsPage }))
);
const StudentEditProfilePage = lazy(() =>
  import('@/features/student/pages/EditProfilePage').then((m) => ({ default: m.EditProfilePage }))
);
const BundlesListPage = lazy(() =>
  import('@/features/student/pages/BundlesListPage').then((m) => ({ default: m.BundlesListPage }))
);
const BundleDetailPage = lazy(() =>
  import('@/features/student/pages/BundleDetailPage').then((m) => ({ default: m.BundleDetailPage }))
);
const SubscriptionsPage = lazy(() =>
  import('@/features/student/pages/SubscriptionsPage').then((m) => ({ default: m.SubscriptionsPage }))
);
const StudentLiveClassesPage = lazy(() =>
  import('@/features/student/pages/LiveClassesPage').then((m) => ({ default: m.LiveClassesPage }))
);
const StudyRemindersPage = lazy(() =>
  import('@/features/student/pages/StudyRemindersPage').then((m) => ({ default: m.StudyRemindersPage }))
);
const CodingProblemsPage = lazy(() =>
  import('@/features/student/pages/CodingProblemsPage').then((m) => ({ default: m.CodingProblemsPage }))
);
const CodingProblemSolvePage = lazy(() =>
  import('@/features/student/pages/CodingProblemSolvePage').then((m) => ({ default: m.CodingProblemSolvePage }))
);
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: ROUTES.COMMUNITY, element: <SuspendedPage Component={CommunityForumsPage} /> },
      { path: '/community/:id', element: <SuspendedPage Component={CommunityTopicPage} /> },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'assignments/:lectureId/submissions', element: <SuspendedPage Component={InstructorSubmissionsPage} /> },
      {
        ...
        element: <SuspendedPage Component={InstructorSubmissionDetailPage} />,
      },
      ...
      { path: 'notifications', element: <SuspendedPage Component={InstructorNotificationsPage} /> },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'announcements', element: <SuspendedPage Component={StudentAnnouncementsPage} /> },
