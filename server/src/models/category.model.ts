...
export const DEFAULT_CATEGORIES: CategorySeedInput[] = [
  ...
  },
  {
    name: 'Data Science',
    slug: 'data-science',
    description: 'Data analysis, visualization, and engineering',
    icon: '📊',
    isActive: true,
  },
  {
  ...
  },
  {
    name: 'Cybersecurity',
    slug: 'cybersecurity',
    description: 'Security, cloud, and infrastructure',
    icon: '🛡️',
    isActive: true,
  },
  {
  ...
  },
  {
    name: 'Marketing',
    slug: 'marketing',
    description: 'Digital marketing, SEO, and growth',
    icon: '📈',
    isActive: true,
  },
  {
    name: 'Finance',
    slug: 'finance',
    description: 'Accounting, investing, and personal finance',
    icon: '💰',
    isActive: true,
  },
  {
    ...
    description: 'Productivity, leadership, and soft skills',
    icon: '🧠',
    isActive: true,
  },
];
