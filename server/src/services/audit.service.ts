...
const SENSITIVE_FIELDS = new Set([
  ...
  'otp', 'otpToken', 'resetToken',
  'creditCard', 'cvv', 'cardNumber', 'cardCvv', 'cardExpiry',
...
const KNOWN_ACTIONS = [
  ...
  'COURSE_APPROVED', 'COURSE_REJECTED', 'COURSE_DELETED',
  ...
  'CERTIFICATE_GENERATED', 'CERTIFICATE_REVOKED', 'CERTIFICATE_RESTORED',
  'BLOG_CREATED', 'BLOG_UPDATED', 'BLOG_DELETED',
  'BANNER_CREATED', 'BANNER_UPDATED', 'BANNER_DELETED',
  'CMS_CREATED', 'CMS_UPDATED', 'CMS_DELETED',
  ...
  'ADMIN_LOGIN', 'ADMIN_LOGOUT', 'PASSWORD_RESET',
  ...
  'ASSIGNMENT_SUBMITTED', 'ASSIGNMENT_UPDATED',
  'ASSIGNMENT_STATUS_CHANGED', 'ASSIGNMENT_GRADED', 'ASSIGNMENT_GRADE_UPDATED',
  'ASSIGNMENT_FEEDBACK_EDITED', 'ASSIGNMENT_RETURNED', 'ASSIGNMENT_PUBLISHED',
  'ASSIGNMENT_REJECTED', 'ASSIGNMENT_OVERRIDE',
  'QUIZ_STARTED', 'QUIZ_SUBMITTED', 'QUIZ_GRADED', 'QUIZ_PUBLISHED', 'QUIZ_OVERRIDE',
  'QUIZ_AUTO_SUBMITTED', 'QUIZ_RESUMED', 'QUIZ_FAILED', 'QUIZ_ENDED', 'QUIZ_COMPLETED',
  'AFFILIATE_COMMISSION_CREDITED', 'AFFILIATE_COMMISSION_REVERSED',
  'AFFILIATE_PAYOUT_REQUESTED', 'AFFILIATE_PAYOUT_APPROVED', 'AFFILIATE_PAYOUT_REJECTED',
  'AFFILIATE_SETTINGS_UPDATED',
  'FAQ_CREATED', 'FAQ_UPDATED', 'FAQ_DELETED',
  'ROLE_PERMISSION_CREATED', 'ROLE_PERMISSION_UPDATED',
  'BACKUP_DELETED',
  'access_denied',
] as const;
...
function computeChangedFields(previous: Record<string, any> | undefined, next: Record<string, any> | undefined): string[] {
